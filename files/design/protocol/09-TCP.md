...
| 偏移 | 字段 | 类型 | 说明 |
|:---|:---|:---|:---|
| 0-1 | ConnHandle | u16 | 连接句柄 / 服务器句柄 / 广播句柄 (0x8000) |
...
| 值 | 说明 |
|:---|:---|
| 0x8001-0xFFFF | 单个连接句柄（Client/子连接），仅发送到该连接 |
| 0x0001-0x7FFF | 服务器句柄，发送至该 Server 下所有已连接 Client |
| 0x8000 | 广播句柄，发送至所有已连接 TCP 连接（不限 Server） |
