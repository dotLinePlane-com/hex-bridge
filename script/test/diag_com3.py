...
print('=== COM3 Diagnostic: SEND + BREAK ===')
print()

transport = MCPTransport()
transport.open()
COM3 = serial.Serial(port='COM3', baudrate=115200, timeout=0.05)
COM3.flushInput()
