...
Covers:
  ...
  TCP-15   TCP_SEND invalid handle → ERR_NET_HANDLE_INVALID
  TCP-14   TCP_CONN_STATUS invalid handle → 0x43
  TCP-18   TCP_SERVER_CLOSE invalid handle → 0x43
  UDP-06   UDP_SERVER_SEND invalid handle → 0x43
  WS-10    WS_SEND invalid handle → 0x43
...
# ============================================================================
# Test: TCP-01 — Server: accept client, receive data, reply back
# ============================================================================
...
# ============================================================================
# Test: TCP-02 — ESP32 as client connects to PC server
# ============================================================================
...
# ============================================================================
# Test: TCP-06/07 — Manual Accept / Reject
# ============================================================================
def test_tcp_06_07(esp_ip):
    ...
    if evt2 is None:
        ...
        if f_r and f_r.payload[0] == ERR_SUCCESS:
            ...
            # Try to recv on PC side — should get 0 bytes (connection closed)
            try:
...
# ============================================================================
# Test: TCP-15 — TCP_SEND with invalid handle
# ============================================================================
def test_tcp_15():
    print('\n' + '=' * 60)
...
# ============================================================================
# Test: TCP-14 — TCP_CONN_STATUS with 0xFFFF
# ============================================================================
def test_tcp_14():
    print('\n' + '=' * 60)
...
# ============================================================================
# Test: TCP-18 — TCP_SERVER_CLOSE with 0x0000
# ============================================================================
def test_tcp_18():
    print('\n' + '=' * 60)
...
# ============================================================================
# Test: UDP-06 — UDP_SERVER_SEND with invalid handle
# ============================================================================
def test_udp_06():
    print('\n' + '=' * 60)
...
# ============================================================================
# Test: WS-10 — WS_SEND with invalid handle
# ============================================================================
def test_ws_10():
    print('\n' + '=' * 60)
